        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    <a href="/dashboard" class="{{ request()->is('dashboard') ? 'active' : '' }} nav-item nav-link "><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
                    <a href="/bed" class="{{ request()->is('bed') ? 'active' : '' }} nav-item nav-link"><i class="fa fa-th me-2"></i>Ruangan dan Bed</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
